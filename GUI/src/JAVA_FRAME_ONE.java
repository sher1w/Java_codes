 ...
 * @author Me
 */
public class JAVA_FRAME_ONE extends javax.swing.JFrame {

    /**
     * Creates new form JAVA_FRAME_ONE
     */
    public JAVA_FRAME_ONE() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton1.setFont(new java.awt.Font("Yu Gothic UI Semibold", 3, 36)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JAVA_FRAME_ONE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JAVA_FRAME_ONE().setVisible(true);
            }
        });
    }
